 ...
 * @since 1.5.0
 */
class BeyonicValidationModuleFrontController extends ModuleFrontController
{
    public function postProcess()
    {
        ...
        if (!preg_match('/^\+\d{6,12}$/', $invoice_address->phone)) {
            $returnMessage = 'Please make sure your phone number is '
                    . 'in international format, starting with a + sign in.';
